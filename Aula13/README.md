...
```
ros2 pkg create PACKAGE_NAME --build-type ament_python --dependencies depend1 depend2 depend2 ... dependN (ej: ros2 pkg create ejemplos --build-type ament_python --dependencies rclpy)
```
